...
*   Updated policy on [prohibited use](#prohibited_use) to clarify human vs human microbiome data, and the requirement for human microbiome data to be collected under IRB-approved protocol.
...
*   Added [National Microbiome Data Collaborative](http://microbiomedata.org/) and [Protein Data Bank](https://www.rcsb.org/) as [data sources](#data_sources). Updated JGI data license to link to their policy site.
...
*   _November_ _2023 update_: Added language to the [user account](#user_account) regarding global access and account deactivation; and the [data policy](#data_policy) section emphasizing that KBase is not intended for proprietary data or use, as KBase supports open research intended to be published in open scientific journals.

[Version 1](https://www.kbase.us/terms-and-conditions/)
...
KBase does not track information in your personal research data other than to provide indexing to support your searches, and verify that the data and its use adheres to the [KBase Use Agreement](#use_agreement). Access to this information is strictly under your control to share or make public.

Once data or Narratives are designated as shared or public, you should be aware that other users of KBase will be able to use them. See the [data policy](#data_policy) section for details.
...
Improper use of KBase, including uploading human data, may result in the termination of KBase access privileges. Please see the [prohibited use](#prohibited_use) section for more information.
...
* Source:  SEED 
  ...
  * Download:  FTP 
* Source: Phytozome
  * License: Free (no embargoed/early release genomes)
  * Download:  Download (login required)
* Source: MycoCosm
  * License: Free (no embargoed/early release genomes)
  * Download:  Download (login required)
* Source:  Gramene 
...
* Source:  JGI 
  * License:  Public Domain –- US Government 
  * Download:  HTTP (genome portal)
* Source: NMDC
  * License: Creative Commons 4.0 with Attribution
  * Download:  HTTP
* Source: Ribosomal Data
  * License: 
  * Download: 
* Source:  Greengenes 
